...
export default function Footer() {
  return (
    <footer className="bg-[#141d33] text-white py-10 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe57] text-white text-sm font-medium px-4 py-2 rounded-md transition-colors"
          >
