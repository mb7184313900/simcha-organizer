    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="bg-blue-900 text-white py-4 px-6 flex justify-between items-center">
        ...
        <nav className="flex gap-6">
          <a href="#" className="hover:text-yellow-300">Guide</a>
          <a href="#" className="hover:text-yellow-300">Organizer</a>
      ...
      <section className="bg-blue-800 text-white text-center py-24 px-6">
        ...
        <div className="flex justify-center gap-4">
          <a href="#" className="bg-yellow-400 text-blue-900 font-bold px-8 py-3 rounded-lg hover:bg-yellow-300">
            Start Free Trial
          </a>
          <a href="#" className="border border-white px-8 py-3 rounded-lg hover:bg-blue-700">
            Learn More
          </a>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20 px-6 text-center">
        ...
        <div className="flex justify-center gap-8 flex-wrap">
          <div className="bg-white border rounded-xl p-8 w-72 shadow-sm">
            ...
            <a href="#" className="block bg-blue-900 text-white py-3 rounded-lg hover:bg-blue-800">Get Started</a>
          </div>
          <div className="bg-blue-900 text-white rounded-xl p-8 w-72 shadow-sm">
            ...
            <a href="#" className="block bg-yellow-400 text-blue-900 font-bold py-3 rounded-lg hover:bg-yellow-300">Get Started</a>
          </div>
        </div>
      </section>
